...
export default async function AboutPage({ params }: AboutPageProps) {
  ...
  return (
    <div className="container space-y-16 py-16">
      <section className="grid gap-12 rounded-4xl border bg-gradient-to-br from-muted/60 via-card to-card/90 p-12 md:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {stats.map((item) => (
              <div
                key={item.label}
                className="rounded-3xl border bg-background/80 px-6 py-5 text-center shadow-sm"
              >
        ...
        <div className="space-y-4 rounded-3xl border bg-background/70 p-8 shadow-md">
      ...
      <section className="space-y-8 rounded-4xl border bg-card/80 p-12 shadow-sm">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {values.map((value) => (
            <div key={value.title} className="rounded-3xl border bg-background/80 p-6">
