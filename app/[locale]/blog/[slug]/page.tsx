  ...
  return (
    <div className="container space-y-16 py-16">
      <section className="space-y-10">
        ...
        {post.coverImage ? (
          <div className="relative overflow-hidden rounded-4xl border bg-muted">
            <Image
              src={post.coverImage}
              alt={post.title}
              width={1600}
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {relatedPosts.map((related) => (
              <Link
                ...
                className="group rounded-3xl border bg-card p-6 transition hover:-translate-y-1 hover:shadow-lg"
              >
      ...
      <section className="rounded-3xl border bg-muted/30 p-10 text-center">
        ...
        <Link
          href={`/${locale}/contact`}
          className="mt-6 inline-flex items-center rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition hover:bg-primary/90"
        >
